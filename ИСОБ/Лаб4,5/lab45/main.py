...
class WorkWindow(QMainWindow):
    ...
    def create_book_ui(self) -> QWidget:
        ...
        self.e_auth.setPlaceholderText("Имя Фамилия")
        layout.addRow('Автор произведения', self.e_auth)

        self.e_pric = QLineEdit()
        self.e_pric.setPlaceholderText("0 $")
        layout.addRow('Цена', self.e_pric)

        self.e_phone = QLineEdit()
        self.e_phone.setPlaceholderText("+375(29) 123-45-67")
