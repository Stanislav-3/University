...
class TimerFragment : Fragment(),  TextToSpeech.OnInitListener {
    ...
    private val viewModelFactory: TimerViewModelFactory by lazy {
        TimerViewModelFactory(requireActivity().application, args.sequence, timerList, args.firstInit, tts)
    }
    ...
    override fun onInit(status: Int) {
        Log.d("*** TimerFragment ***", "TTS INITIALIZATION")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("*** TimerFragment ***", "FRAGMENT ONCREATED")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonPause.setOnClickListener {
            if (timerStatus == TimerStatus.RUN){
                timerViewModel.stop()
                Log.d("*** TimerFragment ***", "STOP CLICKED")
