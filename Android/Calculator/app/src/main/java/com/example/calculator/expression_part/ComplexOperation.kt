...
class ComplexOperation(
    ...
    rightMultiplication: Boolean) : ExpressionPart(content, internalString,
                                                    leftMultiplication, rightMultiplication) {

    constructor(content: String, internalString: String)
            : this(content, internalString, false, false)
